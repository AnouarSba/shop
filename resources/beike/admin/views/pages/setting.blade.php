      ...
      <form action="{{ admin_route('settings.store') }}" class="needs-validation" novalidate method="POST" id="app" v-cloak>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="tab-store">
            ...
            <x-admin-form-select title="{{ __('admin/setting.default_language') }}" name="locale" :value="old('locale', system_setting('base.locale', 'fr'))" :options="$languages" key="code" label="name">
