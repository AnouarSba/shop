...
return [
    ...
    'text_greeting'   => 'Félicitations, votre site Web a installé RacimeLine avec succès ! ',
    'text_greeting_1' => 'Nous vous guiderons pour effectuer quelques configurations personnalisées de base sur le système afin de vous aider à comprendre les fonctions du système RacimeLine et à commencer à l\'utiliser rapidement ! ',
    'text_basic_1'    => 'Tout d\'abord, vous pouvez configurer les informations importantes suivantes dans les paramètres système :',
    'text_lingual_1'  => 'Le système RacimeLine prend en charge plusieurs langues et devises. Avant de commencer à créer votre premier produit, vous pouvez sélectionner la langue et la devise par défaut à la réception du centre commercial ! ',
    ...
    'text_product_2'  => 'RacimeLine offre de puissantes capacités de gestion de produits ! Y compris : <a href="' . admin_route('categories.index') . '">Classification des produits</a>, <a href="' . admin_route('brands.index') . '">Gestion de la marque</a>, produits multi-spécifications, <a href="' . admin_route('multi_filter.index') . '">Filtrage avancé</a>, <a href="' . admin_route('attributes.index') . '">Attributs du produit</a> et autres fonctions. ',
    ...
    'text_payment_1'  => 'RacimeLine fournit des canaux de paiement à l\'étranger couramment utilisés, tels que PayPal, Stripe, etc. Avant de passer officiellement des commandes, vous devez activer et configurer le mode de paiement correspondant. ',
    ...
    'text_payment_4'  => 'Vous pouvez également accéder à RacimeLine<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> pour découvrir et télécharger davantage de méthodes de paiement et de logistique. méthodes ! ',
