...
return [
    ...
    'text_greeting'   => 'تهانينا ، قام موقع الويب الخاص بك بتثبيت RacimeLine بنجاح!',
    'text_greeting_1' => 'سنرشدك إلى إجراء بعض التكوينات المخصصة الأساسية على النظام لمساعدتك على فهم وظائف نظام RacimeLine والبدء في استخدامه بسرعة!',
    'text_basic_1'    => 'أولاً ، يمكنك تكوين المعلومات المهمة التالية في إعدادات النظام:',
    'text_language_1' => 'يدعم نظام RacimeLine لغات وعملات متعددة. قبل البدء في إنشاء منتجك الأول ، يمكنك تحديد اللغة الافتراضية والعملة في مكتب الاستقبال المول!',
    ...
    'text_product_2'  => 'يوفر RacimeLine قدرات قوية لإدارة المنتجات! بما في ذلك: <a href = "' . admin_route('categories.index') . '">Product classification</a>, <a href="' . admin_route('brands.index') . '">Brand management</a>, multi-specification products, <a href="' . admin_route('multi_filter.index') . '">Advanced filtering</a>, <a href="' . admin_route('attributes.index') . '">Product attributes</a> and other functions. ',
    ...
    'text_payment_1'  => 'يوفر RacimeLine قنوات الدفع في الخارج شائعة الاستخدام ، مثل PayPal الافتراضي ، الشريط ، وما إلى ذلك قبل تقديم الطلبات رسميًا ، تحتاج إلى تمكين وتكوين طريقة الدفع المقابلة.',
    ...
    'text_payment_4'  => 'يمكنك أيضًا الذهاب إلى RacimeLine <a href = "' . admin_route('marketing.index') . '">"Plug-in Market"</a> to learn and download more payment methods and logistics methods ! ',
