...
return [
    ...
    'text_greeting'   => 'Congratulations, your website has successfully installed RacimeLine! ',
    'text_greeting_1' => 'We will guide you to make some basic custom configurations on the system to help you understand the functions of the RacimeLine system and start using it quickly! ',
    'text_basic_1'    => 'First, you can configure the following important information in the system settings:',
    'text_language_1' => 'The RacimeLine system supports multiple languages and currencies. Before you start creating your first product, you can select the default language and currency at the mall front desk! ',
    ...
    'text_product_2'  => 'RacimeLine provides powerful product management capabilities! Including: <a href="' . admin_route('categories.index') . '">Product classification</a>, <a href="' . admin_route('brands.index') . '">Brand management</a>, multi-specification products, <a href="' . admin_route('multi_filter.index') . '">Advanced filtering</a>, <a href="' . admin_route('attributes.index') . '">Product attributes</a> and other functions. ',
    ...
    'text_payment_1'  => 'RacimeLine provides commonly used overseas payment channels, such as the default PayPal, Stripe, etc. Before officially placing orders, you need to enable and configure the corresponding payment method. ',
    ...
    'text_payment_4'  => 'You can also go to RacimeLine<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> to learn and download more payment methods and logistics methods ! ',
