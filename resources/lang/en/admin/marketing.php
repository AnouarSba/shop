...
return [
    ...
    'bind_bk_token'           => 'Bind RacimeLine account and get Token automatically',
    'bk_login_hint'           => 'Log in with <a href="' . beike_url() . '/account" target="_blank">RacimeLine.com</a> account',
    'bk_register_hint'        => 'Register a new account with <a href="' . beike_url() . '/account" target="_blank">RacimeLine.com</a>',
    'btn_buy'                 => 'Buy',
    ...
    'get_token'               => 'Get Token',
    'get_token_text'          => 'Log in to RacimeLine official website personal center - bind domain name, add current domain name',
    ...
    'domain_token_domain_error' => 'The current domain name: :domain is inconsistent with the domain name bound to the Token: :token_domain. Please confirm before purchasing, or rebind the Token. <a href="https://docs.RacimeLine.com/config/plugin_token.html?lang=' . locale() . '" target="_blank">View the tutorial</a>',
