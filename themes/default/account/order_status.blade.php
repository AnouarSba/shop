<ul class="nav nav-tabs order-status-wrap">
  ...
  <li class="nav-item" role="presentation">
    <a class="nav-link {{ request('status') == 'unconfirmed' ? 'active' : '' }}" href="{{ shop_route('account.order.index', ['status' => 'unconfirmed']) }}">{{ __('order.unconfirmed') }}</a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link {{ request('status') == 'confirmed' ? 'active' : '' }}" href="{{ shop_route('account.order.index', ['status' => 'confirmed']) }}">{{ __('shop/account.pending_send') }}</a>
  </li>
  <li class="nav-item" role="presentation">
