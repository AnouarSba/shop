...
@section('content')
  <div class="install-2">
		...
		<div class="d-flex justify-content-center flex-column align-items-center">
			...
			<div class="welcome-img mb-5" style="max-width: 230px;"><img src="https://RacimeLine.com/install/install-2.png?version={{ config('beike.version') }}&build_date={{ config('beike.build') }}" class="img-fluid"></div>
