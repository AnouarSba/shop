...
return [
    ...
    'welcome'      => [
        ...
        'statement_1'      => '免责声明：',
        'statement_2'      => '风险声明：RacimeLine系统的使用和安装是基于您自己的决定。我们不对使用本系统可能产生的任何损失、损害或法律责任承担责任',
    ...
    */
    ...
    'final'        => [
        ...
        'to_front'       => '访问前台',
        'to_admin'       => '访问后台',
        'nginx_alert'       => 'Nginx 服务器需要配置伪静态规则，点击 <a href="https://docs.RacimeLine.com/install/source.html#nginx" target="_blank">查看配置方法</a>',
    ],
];
