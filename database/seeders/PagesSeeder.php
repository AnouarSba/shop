    ...
    public function getPageDescriptions()
    {
        ...
        return [
            ...
            [
                ...
                "page_id" =>22,
                "locale" =>"fr",
                "title" =>"RacimeLine {$version} 新版版本发布！！！",
                "summary" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等.....",
                "content" =>"<p>RacimeLine {$version} 新版版本发布！！！</p>",
                "meta_title" =>"",
                "meta_description" =>"",
                "meta_keywords" =>"",
            ],
            [
                ...
                "page_id" =>22,
                "locale" =>"en",
                "title" =>"RacimeLine {$version} new version released! ! !",
                ...
                "content" =>"<p>RacimeLine {$version} new version released! ! !</p>",
                "meta_title" =>"",
                "meta_description" =>"",
                "meta_keywords" =>"",
            ],
            [
                ...
                "page_id" =>23,
                "locale" =>"fr",
                "title" =>"新一代开源跨境电商系统，RacimeLine重磅上线！",
                "summary" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等...",
                "content" =>"随着一带一路的蓬勃发展，以及中国制造亟需出海拓展全球市场，外贸行业仍然是大国创造GDP的核心引擎.光大网络科技长期深耕跨境电商行业，经过多年的摸索与思考，开发出了一套更加符合国内出海企业需求的开源电商系统&mdash;&mdash;RacimeLine&mdash;&mdash;助力企业品牌出海。",
                "meta_title" =>"",
                "meta_description" =>"",
                "meta_keywords" =>"",
            ],
            [
                ...
                "page_id" =>23,
                "locale" =>"en",
                "title" =>"A new generation of open source cross-border e-commerce system, RacimeLine is launched!",
                "summary" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
                "content" =>"随着一带一路的蓬勃发展，以及中国制造亟需出海拓展全球市场，外贸行业仍然是大国创造GDP的核心引擎.光大网络科技长期深耕跨境电商行业，经过多年的摸索与思考，开发出了一套更加符合国内出海企业需求的开源电商系统&mdash;&mdash;RacimeLine&mdash;&mdash;助力企业品牌出海",
                "meta_title" =>"",
                "meta_description" =>"",
            ...
            [
                ...
                "page_id" =>24,
                "locale" =>"en",
                "title" =>"RacimeLine multi-language support helps you",
                "summary" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
            ...
            [
                ...
                "page_id" =>25,
                "locale" =>"fr",
                "title" =>"性能提升秘籍 | 如何打造闪电般快速的 RacimeLine",
                "summary" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等.....",
                "content" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等.....",
                "meta_title" =>"",
                "meta_description" =>"",
            ...
            [
                ...
                "page_id" =>25,
                "locale" =>"en",
                "title" =>"Performance Tips | How to Build a Lightning-Fast RacimeLine",
                "summary" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
                "content" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
                "meta_title" =>"",
                "meta_description" =>"",
